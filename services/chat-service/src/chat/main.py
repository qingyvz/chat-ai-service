...
from chat.domain.entities import ChatSession, ChatMessage, Provider, Model, ModelProviderMapping, Plan
...
async def lifespan(app: FastAPI):
    ...
    await init_beanie(
        ...
        document_models=[ChatSession, ChatMessage, Provider, Model, ModelProviderMapping, Plan],
    )
